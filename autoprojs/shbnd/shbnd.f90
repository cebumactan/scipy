...
!      DOUBLE PRECISION V0(NDM),V1(NDM),G0(NDM),G1(NDM)
      ...
      DOUBLE PRECISION EPS0, EPS1, A, M, N, L, D, a, b, P, Q, R, R0, R1
...
! unit length eigenvectors
	FB(22)= PAR(7)**2  + PAR(8)**2  + PAR(9)**2  -1
	FB(23)= PAR(10)**2 + PAR(11)**2 + PAR(12)**2 -1
	FB(24)= PAR(13)**2 + PAR(14)**2 + PAR(15)**2 -1
	FB(25)= PAR(16)**2 + PAR(17)**2 + PAR(18)**2 -1
	FB(26)= PAR(19)**2 + PAR(20)**2 + PAR(21)**2 -1

! unit length coefficients
	FB(25)= PAR(22)**2 + PAR(23)**2 + PAR(24)**2 -1
	FB(26)= PAR(25)**2 + PAR(26)**2 + PAR(27)**2 -1
